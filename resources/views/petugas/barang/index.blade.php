            ...
            <tr style="border-top:1px solid var(--border);">
                ...
                <td style="padding:12px 16px;">
                    <div style="display:flex; gap:6px;">
                        ...
                        <button type="button"
                            onclick="bukaMHapus('{{ route('petugas.barang.destroy', $item->id_barang) }}')"
                            style="padding:5px 12px; background:#FEF2F2; color:#DC2626; border:none; border-radius:6px; font-size:12px; font-weight:700; cursor:pointer; font-family:inherit;">Hapus</button>
                        @endif
                    </div>
                </td>
            </tr>
