...
<div style="max-width:640px;">
    ...
    <div style="background:white; border-radius:12px; border:1px solid var(--border); padding:28px;">
        <form id="form-edit-barang" method="POST" action="{{ isset($barang) ? route('admin.barang.update', $barang->id_barang) : route('admin.barang.store') }}" enctype="multipart/form-data">
            @csrf
...
<script>
document.getElementById('modal-simpan').addEventListener('click', function(e) {
