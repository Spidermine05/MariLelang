...
<div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:20px;">
    ...
    <a href="{{ route('admin.barang.create') }}" style="padding:8px 18px; background:var(--brand); color:white; border-radius:8px; font-size:13px; font-weight:700; text-decoration:none;">+ Tambah Barang</a>
</div>
    ...
    <table style="width:100%; border-collapse:collapse; font-size:13px;">
        ...
        <tbody>
            ...
            <tr style="border-top:1px solid var(--border);">
                <td style="padding:12px 16px;"><img src="{{ $item->foto_url }}" style="width:44px; height:44px; object-fit:cover; border-radius:6px; border:1px solid var(--border);"></td>
                ...
                <td style="padding:12px 16px;">
                    @php $c=['tersedia'=>'#EEF2FF:#4F46E5','dilelang'=>'#FFFBEB:#D97706','terjual'=>'#ECFDF5:#059669']; [$bg,$fg]=explode(':',$c[$item->status_barang]??'#F1F5F9:#64748B'); @endphp
                ...
                <td style="padding:12px 16px;">
                    <div style="display:flex; gap:6px;">
                        ...
                        <form method="POST" action="{{ route('admin.barang.destroy', $item->id_barang) }}" onsubmit="return confirm('Hapus?')">
                            @csrf @method('DELETE')
